...
public class ConexionDB extends SQLiteOpenHelper{
    ...
    public static final String  SQL_TABLA        ="CREATE TABLE contactos(id INTEGER PRIMARY KEY AUTOINCREMENT,nombre TEXT,apellido TEXT,direccion TEXT,telefono TEXT,correo TEXT,sexo TEXT,fechan TEXT)";
