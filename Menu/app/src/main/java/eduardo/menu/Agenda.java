...
public class Agenda {
    ...
    public void agregar(String nombre,String apellido,String direccion,String telefono,String correo,String sexo,String fechan){
    ...
    public void update(int position,int id,String nombre,String apellido,String direccion,String telefono,String correo,String sexo,String fechan){

        try {
            ConexionDB conexion = new ConexionDB(contexto,null,null,1);
            SQLiteDatabase db   = conexion.getReadableDatabase();

            db.execSQL("UPDATE contactos SET nombre='"+nombre+"',apellido='"+apellido+"',fechan='"+fechan+"' WHERE id="+position);
    ...
    public ArrayList<Contacto> lista(){
        ...
        try {
            ...
            Cursor cursor = db.rawQuery("select nombre,apellido,id,direccion,telefono,correo,sexo,fechan from contactos",null);
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    String fechan       = cursor.getString(7);

                    items.add(new Contacto(id,nombre,apellido,direccion,telefono,correo,sexo,fechan));
    ...
    public Contacto getContacto(int position){
        ...
        try {
            ...
            Cursor cursor = db.rawQuery("select nombre,apellido,direccion,telefono,correo,sexo,id,fechan from contactos where id="+position,null);
            ...
            if (cursor.moveToFirst()) {
                ...
                contacto    =new Contacto(id,nombre,apellido,direccion,telefono,correo,sexo,fechan);
                return contacto;
            }
