...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public static final String  TABLA_AGENDA      ="CREATE TABLE agenda(id INTEGER PRIMARY KEY AUTOINCREMENT,id_medico INTEGER,descripcion text,fecha text,hora text,recordatorio integer,fechar text,horar text)";
