...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        /*creacion de programas academicos*/
        if (id == R.id.nav_newestudiando) {
            openEstudiante();

        /*creacion de programas academicos*/
        } else if (id == R.id.nav_newprogram) {
            openPrograma();
        /*listar programas academicos*/
        } else if (id == R.id.nav_listprogram) {
            openListProgram();
        }
