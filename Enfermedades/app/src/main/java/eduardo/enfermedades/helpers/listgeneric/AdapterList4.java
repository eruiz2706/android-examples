...
public class AdapterList4 extends BaseAdapter {

    protected Activity activity;
    protected ArrayList<DatosList> items;

    public AdapterList4(Activity activity, ArrayList<DatosList> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        etiq3.setText("recordatorio :");

        TextView  dato3   =(TextView) view.findViewById(R.id.tv_dato3_listgeneric);
        dato3.setText(datos.getDescripcion2());

        TextView etiq4    =(TextView) view.findViewById(R.id.tv_etiq4_listageneric);
        etiq4.setText("Fecha y hora :");

        TextView  dato4   =(TextView) view.findViewById(R.id.tv_dato4_listgeneric);
        dato4.setText(datos.getDescripcion3());
